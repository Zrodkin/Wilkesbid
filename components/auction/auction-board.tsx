        ...
        <div className="relative max-w-3xl mx-auto">
          <div className="relative group">
            ...
            <input
              ...
              className="w-full pl-12 sm:pl-14 pr-4 py-5 sm:py-6 md:py-7 text-base sm:text-lg bg-neutral-800 border-2 border-neutral-700 focus:border-[#C9A961] focus:ring-2 focus:ring-[#C9A961]/20 rounded-xl shadow-md focus:shadow-lg transition-all text-white placeholder:text-neutral-500 outline-none"
            />
          </div>
          {searchQuery && (
        ...
        <section className="space-y-4 sm:space-y-5 md:space-y-6">
          <div className="flex items-center justify-between gap-4">
            <h2 className="font-serif text-2xl sm:text-3xl md:text-4xl font-bold text-[#C9A961] border-b-2 border-[#C9A961] pb-2 sm:pb-3 flex-1">
              {sortFilter ? `All Honors - ${sortFilter}` : "Auction Honors"}
            </h2>
